...
const stops = [
  ...
  { id:1, label:'T1', name:'Turn 1',
    ...
    facts:[
      {icon:'🏆',tag:'overtake',title:'2024 — Piastri takes the lead',text:"On lap 20, <strong>Oscar Piastri</strong> swooped past <strong>Charles Leclerc</strong> into Turn 1 for the race lead, going on to win — a result that put McLaren top of the Constructors' Championship for the first time since 2014."},
