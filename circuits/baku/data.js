...
const stops = [
  ...
  { id:1, label:'T1', name:'Turn 1', 
    ...
    desc:'The first braking zone of the lap, a right-hander off the seafront straight. Sets up the run toward the hill climb into the old town.',
    facts:[]},
  { id:2, label:'Climb', name:'The Climb', 
    ...rl(33), sector:1, speed:null, gear:null, dist:'1.14',
    desc:"A steep uphill run toward the Old City walls — regularly described as one of the steepest climbs on the F1 calendar, though we haven't found an official gradient figure to cite precisely.",
    facts:[]},
  { id:3, label:'Old City', name:'Old City', 
    ...rl(51), sector:2, speed:null, gear:null, dist:'1.75',
    desc:"The track narrows sharply here, entering the medieval streets of Icherisheher, Baku's walled Old City and a UNESCO World Heritage Site.",
    facts:[
  ...
  { id:4, label:'T8', name:'The Castle Section', 
    ...rl(114), sector:2, speed:null, gear:null, dist:'3.58',
    desc:"Turns 8 to 10 form the narrowest point on the entire Formula 1 calendar — barely wide enough for two cars side by side, right alongside the Old City's medieval fortress wall.",
    facts:[
      {icon:'📏',tag:'record',title:'Narrowest point in F1: 7.6 metres',text:"At its tightest, the track here is just <strong>7.6 metres wide</strong> — the narrowest point on the F1 calendar. Drivers commit to one steering line through Turns 8, 9 and 10 and hold it, since there's no room to correct a mistake next to the stone wall."},
    ]},
  { id:5, label:'Home', name:'The Home Straight', 
