...
const stops = [
  ...
  { id:4, label:'T4', name:'Turn 4',
    ...rl(48), sector:1, speed:null, gear:null, dist:'1.62',
  ...
  { id:7, label:'T7', name:'Turn 7',
    ...rl(72), sector:1, speed:null, gear:null, dist:'2.38',
  ...
  { id:12, label:'T12', name:'Turn 12',
    ...rl(98), sector:2, speed:null, gear:null, dist:'3.01',
  ...
  { id:13, label:'T13', name:'Turn 13',
    ...rl(108), sector:2, speed:null, gear:null, dist:'3.35',
  ...
  { id:15, label:'T15', name:'Turn 15',
    ...rl(125), sector:2, speed:null, gear:null, dist:'3.93',
  ...
  { id:20, label:'T20', name:'Turn 20',
    ...
    facts:[
      ...
      {icon:'💥',tag:'crash',title:"2021 — Verstappen's late tyre failure",text:"Leading with four laps to go, <strong>Max Verstappen's</strong> left-rear tyre failed at high speed on the pit straight, sending him into the wall and triggering a red flag. Sergio Pérez went on to win from the restart."},
    ]},
];
