...
const stops = [
  ...
  { id:15, label:'T15', name:'Turn 15',
    ...
    facts:[
      {icon:'💥',tag:'crash',title:"Baku's most-crashed corner",text:"This downhill braking zone has claimed cars in nearly every year the circuit has run: <strong>Daniel Ricciardo</strong> and <strong>Felipe Massa</strong> both crashed here in practice in 2016, <strong>Charles Leclerc</strong> in practice in 2021, and <strong>Max Verstappen</strong> in qualifying the same year."},
    ]},
