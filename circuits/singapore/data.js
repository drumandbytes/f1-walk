...
const racingLine = [
  ...
  [1.290448,103.852175],[1.290173,103.852022],[1.289899,103.851868],[1.289625,103.851715],[1.289366,103.851563],[1.289229,103.851569],
  [1.289073,103.851594],[1.288962,103.851648],[1.28883,103.851798],[1.288694,103.851992],[1.288593,103.85215],[1.28853,103.852334],
...
const stops = [
  { id:0, label:'S/F', name:'Start / Finish Line', isSF:true,
    ...
    desc:'Just off the pit straight, beside the Singapore Flyer — the only circuit on the F1 calendar raced entirely at night under floodlights.',
    facts:[
      {icon:'🏁',tag:'fact',title:'4.927 km, 19 corners',text:'Marina Bay Street Circuit is <strong>4.927 km</strong> long with <strong>19 turns</strong>. It hosted F1\'s first-ever night race in 2008 and remains the only circuit run entirely after dark.'},
  ...
  { id:1, label:'T1', name:'Turn 1',
    ...rl(10), sector:0, speed:null, gear:null, dist:'0.31',
  ...
  { id:3, label:'T3', name:'Turn 3',
    ...rl(33), sector:0, speed:null, gear:null, dist:'0.82',
    desc:'A left-handed hairpin, heavy on the brakes.',
    facts:[]},
  { id:4, label:'T4', name:'Turn 4',
    ...rl(42), sector:0, speed:null, gear:null, dist:'1.07',
  ...
  { id:6, label:'T6', name:'Turn 6',
    ...rl(55), sector:0, speed:null, gear:null, dist:'1.56',
    desc:'A right-hand kink before the run toward the bridge section.',
    facts:[]},
  { id:7, label:'T7', name:'Turn 7',
    ...rl(65), sector:0, speed:null, gear:null, dist:'1.83',
  ...
  { id:11, label:'T11', name:'Turn 11',
    ...rl(93), sector:0, speed:null, gear:null, dist:'2.61',
    desc:'A fast right, funnelling the car toward Anderson Bridge.',
    facts:[]},
  { id:12, label:'T12', name:'Turn 12',
    ...rl(104), sector:0, speed:null, gear:null, dist:'2.80',
  ...
  { id:13, label:'T13', name:'Turn 13',
    ...rl(121), sector:0, speed:null, gear:null, dist:'3.19',
